...
linux-rpi linux-rpi4 raspberrypi-bootloader openssh haveged alpine-conf eudev eudev-libs eudev-openrc eudev-rule-generator"
SOFTWARE_ADDITIONAL="python3 py3-pip"
USER_FIRST_USER_USERNAME="automation"
USER_FIRST_USER_SSHPUBKEY_SRCFILE=/tmp/id_rsa.pub
USER_FIRST_USER_SSHPUBKEY=""
SYSTEM_HOST_NAME=""
SYSTEM_KEYMAP=""
SYSTEM_TIME_ZONE="UTC"
BOOTUSERCFG="gpu_mem=32 dtparam=audio=off"
echo -n "" > $ENV
...
KEYS="SOFTWARE_SYSTEM SOFTWARE_ADDITIONAL USER_FIRST_USER_USERNAME USER_FIRST_USER_SSHPUBKEY USER_FIRST_USER_SSHPUBKEY_BASE64 SYSTEM_HOST_NAME SYSTEM_KEYMAP SYSTEM_TIME_ZONE ARCH"
